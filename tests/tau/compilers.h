...
#define TAU_DISABLE_DEBUG_WARNINGS                                             \
  ...
  /* '__cplusplus' is not defined as a preprocessor macro, replacing with '0'  \
   * for '#if/#elif' */                                                        \
  TAU_MSVC_SUPPRESS_WARNING(4668)                                              \
  /* 'fprintf' : format string '' requires an argument of type 'unsigned       \
   * __int64', but variadic */                                                 \
  /* argument 1 has type 'size_t' */                                           \
  TAU_MSVC_SUPPRESS_WARNING(4777)                                              \
  /* https://stackoverflow.com/questions/39479163 - what's the difference      \
   * between 4018 and 4389 */                                                  \
  ...
  /* In multi-platform code, we cannot use the non-standard "safe" functions   \
   * from */                                                                   \
  ...
  /* io.h contains definitions for some structures with natural padding. This  \
   * is uninteresting, */                                                      \
  /* but for some reason, MSVC's behaviour is to warn about including this     \
   * system header. That  */                                                   \
  /* *is* interesting */                                                       \
