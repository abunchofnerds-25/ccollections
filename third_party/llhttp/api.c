...
int llhttp__on_header_field_complete(llhttp_t* s, const char* p,
                                     const char* endp) {
  int err;
...
int llhttp__on_header_value_complete(llhttp_t* s, const char* p,
                                     const char* endp) {
  int err;
...
int llhttp__on_chunk_extension_name(llhttp_t* s, const char* p,
                                    const char* endp) {
  int err;
...
int llhttp__on_chunk_extension_name_complete(llhttp_t* s, const char* p,
                                             const char* endp) {
  int err;
...
int llhttp__on_chunk_extension_value(llhttp_t* s, const char* p,
                                     const char* endp) {
  int err;
...
int llhttp__on_chunk_extension_value_complete(llhttp_t* s, const char* p,
                                              const char* endp) {
  int err;
